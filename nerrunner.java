...
public void testtwo(){
  ...
  test = reports.createTest("click on France");
       LoggerHandler.info("click on Property");
      test.pass("click");
       for(int i=0;i<300;i++)
        {
           LoggerHandler.info("click on Property");
         ...
         Screenshot.captureScreenShot("expedia_screenshot");
        test.addScreenCaptureFromPath("/home/coder/project/workspace/Project/screenshots/expedia_screenshot2025.12.03.16.11.17.png");
}
